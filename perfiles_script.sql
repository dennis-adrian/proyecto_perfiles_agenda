...
CREATE TABLE IF NOT EXISTS "licenciado" (
    ...
    CONSTRAINT fk_tipo_licenciado FOREIGN KEY("id_tipo_licenciado") REFERENCES "tipo_licenciado"("id"),
...
CREATE TABLE IF NOT EXISTS "perfil_tesis" (
    "id" INTEGER PRIMARY KEY,
    "tema" TEXT NOT NULL,
    "estado" TEXT COMMENT 'rechazado, aprobado, en revision, en conclusion, abandonado, etc' NOT NULL,
    "fecha_aprobacion_jefe_carrera" TEXT,
    "fecha_recepcion_titulacion" TEXT,
    "estado_defensa" TEXT COMMENT 'aprobada o reprobada',
    "calificacion" REAL,
    "id_tutor" INTEGER COMMENT 'tutor de tesis' NOT NULL,
    "creado_en" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "modificado_en" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT fk_tutor_perfiltesis FOREIGN KEY("id_tutor") REFERENCES "licenciado"("id")
);
...
CREATE TABLE IF NOT EXISTS "detalle_defensa" (
    ...
    "id_licenciado" INTEGER NOT NULL,
    "id_tipo_licenciado" INTEGER NOT NULL,
    "creado_en" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "modificado_en" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
